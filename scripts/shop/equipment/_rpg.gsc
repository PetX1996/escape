...
OnGiveEquipment( name )
{
	...
	self scripts\shop\_equipment::SetEquipmentInfo( name, self GetAmmoCount( "rpg_mp" ), "weapon", "rpg_mp" );
...
OnEndFiring( weapon )
{
	...
	self scripts\shop\_equipment::UpdateEquipmentInfo( self GetAmmoCount( "rpg_mp" ) );
}
